...
namespace MelonPay.Shared.Infrastructure.Contracts
{
    ...
    {
        private const string ModulesDirectory = "MelonPay.Modules";
        ...
        private void ValidateContract(Type contractType, string path = null)
        {
            ...
            var contractModule = contract.Module;
            ...
            var originalType = _types
                .Where(x => x.FullName is not null &&
                            x.FullName.Contains($"{ModulesDirectory}.{module}", StringComparison.InvariantCultureIgnoreCase))
            ...
            _logger.LogTrace($"Validating the contract for: '{contractName}', from module: '{contractModule}', original module: '{module}'...");
        ...
        {
            public EmptyContract(string module) : base(module)
            {
            }
        }
    }
